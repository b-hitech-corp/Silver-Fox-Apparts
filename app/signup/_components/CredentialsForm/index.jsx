...
import { signupAction } from "@/app/_lib/actions/signup";
...
function CredentialsForm({ registerAction, authAction }) {
  ...
  if (errors.length)
    errors.forEach((item) =>
      toast.error(item ?? "Failed to sign up, please try again")
    );
  ...
  return (
    <form action={formAction} className={styles.form}>
      ...
      <div className={styles.formControl}>
        ...
        <input type="text" name="fullname" className={styles.loginInput} required />
        {state.fullname && (
      ...
      <div className={styles.formControl}>
        ...
        <input type="email" name="email" className={styles.loginInput} required />
        {state.email && (
